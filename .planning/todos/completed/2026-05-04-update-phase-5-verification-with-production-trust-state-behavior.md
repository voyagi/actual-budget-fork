...
- `INFRA-05` and `INFRA-06` are marked complete in `REQUIREMENTS.md`.
- Phase 5 validation records warning activation and deterministic clearing evidence.
- The production readiness warning appeared while bank sync was untrusted and cleared only after bank-sync recovery evidence was present.
